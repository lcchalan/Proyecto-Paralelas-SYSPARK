            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 col-sm-6 scrollpoint sp-effect1">
                        <form role="form" enctype="multipart/form-data" id='formP'method="POST" >
                            <?php 
                            $consulta="select * from parqueadero where CedulaAdmin=".$_SESSION["CedulaAdmin"];
                            $resultado=$conexion->query($consulta);
                            while ($fila=$resultado->fetch_assoc()) {    
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="DireccionParqueadero" id="DireccionParqueadero" value='<?php echo $fila["DireccionParqueadero"] ?>'>
                                </div>
                                <div class="form-group">
                                    <p>Telefono</p>                                        
                                ...
                                while ($fila2=$resultado2->fetch_assoc()) {
                                    if ($fila2['IdParqueadero']==$_SESSION['IdParqueadero']) {
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            <p>Ingrese Valor de puestos Simples</p>
                                         ...
                                         <div class="form-group col-md-6 f">
                                            <p>Ingrese el numero de puestos Simples</p>
                                            <input required type="text" class="form-control" name="numeroSimples" id="numeroSimples"><br>                                    
                                        </div>
                                        

                                        <div class="form-group col-md-6">                                    
                                            <p>Ingrese Valor de puestos Cubiertos</p>                                        
                                        ...
                                        <div class="form-group col-md-6 f">                                    
                                            <p>Ingrese el numero de puestos Cubiertos</p>
                                            <input type="text" class="form-control" name="numeroCubiertos" id="numeroCubiertos" ><br>                                    
                                        </div>

                                        <div class="form-group col-md-12">                                    
                                            <p>Agregue una Imagen del parqueadero</p>                                        
                                            <input type="file" class="" name="imagen" id="imagen">
                                        </div>

                                        <div class="form-group col-md-12">                                    
                                        <p>Arrastre el marcador en el mapa para ubicar su parqueadero</p>                                        
                                        <div class="col-md-6">
                                            <input required type="text"  class="form-control" name='LatitudParqueadero' id='LatitudParqueadero' value='<?php echo $fila["LatitudParqueadero"] ?>'>
                                        </div>
                                        <div class="col-md-6">
                                            <input required type="text"  class="form-control col-md-3" name='LogitudParqueadero' id='LogitudParqueadero' value='<?php echo $fila["LogitudParqueadero"] ?>'>                                   
                                        </div>
                                </div>
                                <?php  } ?>
                            </form>
                            <div class='form-group col-md-12'>
                                <button type='submit' onclick="updateParqueadero()" class="btn btn-primary btn-lg" data-toggle='modal' data-target='.update'>Enviar</button>
                                </div>
                        </div>
