                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#" data-toggle="modal" data-target=".bs-example-modal-sm">Iniciar Sesión</a>   
                            </li>                            
                            ...
                            <?php if (isset($_SESSION['CedulaAdmin'])){
                                echo "<li><a  href='cerrarsesion.php' data-toggle='modal' data-target='.logout'>Cerrar Sesion</a>";
                                echo "</li>";
                            } else{}  ?>
                        </ul>
                    </div>
